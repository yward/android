...
class NotificationsManagerImpl @Inject constructor(
    ...
    private val platformNotificationsManager: android.app.NotificationManager
    ...
    override fun postDownloadProgress(fileOwner: User, file: OCFile, progress: Int, allowPreview: Boolean) {
        ...
        platformNotificationsManager.notify(NotificationsManager.DOWNLOAD_NOTIFICATION_ID, builder.build())
    }

    override fun cancelDownloadProgress() {
        platformNotificationsManager.cancel(NotificationsManager.DOWNLOAD_NOTIFICATION_ID)
    }
}
